...
public class Player2Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        firing = Input.GetButtonDown("Fire1P2");
        ...
        shootDirection = new Vector2(Input.GetAxisRaw("Horizontal2P2"), Input.GetAxisRaw("Vertical2P2"));
        checkGrounded();
        ...
        {
            temp.GetComponent<boomerang>().verticalForce = Input.GetAxis("VerticalP2") * 2f;
        }
    }
